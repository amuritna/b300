...
for counter = 0:floor(length(yt)/N)-1
    ...
    % VVV 56784321
    % 09:10 11:12 13:14 15:16 07:08 05:06 03:04 01:02
    f_scramble(01:02) = f_window(15:16);
    f_scramble(03:04) = f_window(13:14);
    f_scramble(05:06) = f_window(11:12);
    f_scramble(07:08) = f_window(09:10);
    f_scramble(09:10) = f_window(07:08);
    f_scramble(11:12) = f_window(05:06);
    f_scramble(13:14) = f_window(03:04);
    f_scramble(15:16) = f_window(01:02);
...
for counter = 0:floor(length(yt2)/N)-1
    ...
    % VVV 56784321
    % 09:10 11:12 13:14 15:16 07:08 05:06 03:04 01:02
    f_new(01:02) = f_window(15:16);
    f_new(03:04) = f_window(13:14);
    f_new(05:06) = f_window(11:12);
    f_new(07:08) = f_window(09:10);
    f_new(09:10) = f_window(07:08);
    f_new(11:12) = f_window(05:06);
    f_new(13:14) = f_window(03:04);
    f_new(15:16) = f_window(01:02);
